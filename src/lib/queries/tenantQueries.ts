...
import {
  ...
  getTenantById as apiGetTenantById,
  getAllTenants as apiGetAllTenants,
...
export const tenantKey = (id: string | undefined) =>
  id ? ['tenants', id] : ['tenants', 'unknown'];
...
export function useTenants(params?: {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const res = await apiGetAllTenants(params ?? {});
